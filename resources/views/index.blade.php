...
<head>
    ...
    <title>Pacha Mama Spirit an exclusive travel agency for Perú</title>
...
<body>
    ...
    <li>
        <button onclick="window.location='inicio'" class="castellano-es">Español</button>
    </li>
            ...
            <div class="row">
                <div class="col-12 mx-auto">
                    <form class="form-index">
                        @csrf
                        <h3 class="h1-index-book">Book your travel to Perú!</h3>
                        <div class="form-row">
