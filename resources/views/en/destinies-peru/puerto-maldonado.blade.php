...
<head>
    ...
    <title>Puerto Maldonado is the capital of the Madre de Dios region</title>
    <meta name="description"
        content="It is also known as the southern gateway to the Amazon jungle. The central tower of the Obelisk has a view of the city from above..." />
    <meta name="keywords"
        content="city of puerto maldonado, puerto maldonado, the peruvian jungle, madre de Dios, capitl de madre de dios, wild animals, amazonia peru, amazonia peru" />
    ...
    <link rel="canonical" href="https://pachamamaspirit.com/en/destinies-peru/puerto-maldonado" />
</head>

<body>
    @include('layouts.menu')
    <li>
        <button onclick="window.location='{{ route('puerto-maldonado') }}'" class="castellano-es">Español</button>
    </li>
