...
<head>
    ...
    <title>The white city of Arequipa, a city that rests under a volvan</title>
    <meta name="description"
        content="Arequipa is known as the White City due to its architecture built with white volcanic stone" />
    <meta name="keywords"
    ...
    <meta name="twitter:title" content="The white city of Arequipa, a city that rests under a volvan">
    <meta property="og:image"
        content="https://pachamamaspirit.com/img/galeria/Monasterio-de-Santa-Catalina-Arequipa.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/en/destinies-peru/arequipa-the-white-city" />
</head>

<body>
    @include('layouts.menu')
    <li>
        <button onclick="window.location='{{ route('arequipa-la-ciudad-blanca') }}'"
