...
<head>
    ...
    <title>Pisco, this city saw the birth of its homonymous drink.</title>
...
<body>
    ...
    <li>
        <button onclick="window.location='{{ route('ciudad-de-pisco') }}'" class="castellano-es">Español</button>
    </li>
