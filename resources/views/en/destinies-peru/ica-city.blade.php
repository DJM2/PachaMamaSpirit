...
<head>
    ...
    <title>Ica, also known as the city of the eternal sun, cradle of pisco or city of the sun</title>
...
<body>
    ...
    <li>
        <button onclick="window.location='{{ route('ciudad-de-ica') }}'" class="castellano-es">Español</button>
    </li>
