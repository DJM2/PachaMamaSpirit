...
<body>
    ...
    <div class="aventuras">
        <div class="container">
            <div class="row">
                <h1 class="h1-destinos">Camino Inca 4 días</h1>
            </div>
        </div>
    </div>
    </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-llevar" role="tabpanel"
                                ...
                                <ul class="paneles">
                                    ...
                                    <li>&#10038; Almacenamiento de agua: se recomiendan depósitos de agua como Camelbaks, pero
                                    ...
                                    <li>&#10038; Toalla</li>
                                    <li>&#10038; 1 Botella de jabon liquido pequeña: proporcionamos agua tibia todos los días
                                        para
