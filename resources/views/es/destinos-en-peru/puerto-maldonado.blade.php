...
<head>
    ...
    <title>Puerto Maldonado es la capital de la región de Madre de Dios.</title>
    <meta name="description"
        content="También es conocida como la vía de acceso al sur de la selva del Amazonas. La torre central del Obelisco tiene vista desde lo alto a la ciudad..." />
    <meta name="keywords"
        content="Ciudad de Puerto maldonado, puerto maldonado, la selva peruana, madre de Dios, capitl de madre de dios, animales silvestres, amazonia peru, amzonia de perú" />
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="https://pachamamaspirit.com/img/panoramico/puerto-maldonado-peru.webp">
    <meta property="og:image" content="https://pachamamaspirit.com/img/panoramico/puerto-maldonado-peru.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/es/destinos-en-peru/puerto-maldonado" />
</head>

<body>
    @include('layouts.menu-castellano')
    <li>
        <button onclick="window.location='{{ route('puerto-maldonado-en') }}'" class="castellano-es">English</button>
    </li>
