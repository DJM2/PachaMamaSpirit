...
<body>
    ...
    <li>
        <button onclick="window.location='{{route('cusco-navel-of-the-world')}}'" class="castellano-es">English</button>
    </li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="details">
                        <div class="location">
                            <p><a href="{{route('inicio')}}">Inicio</a> / <a href="{{route('destinos-peru')}}">Destinos</a> / <a>Cusco</a>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    De este modo, la ciudad fue y es llamada el ombligo del mundo, en referencia al universo. Sin embargo, ninguna lengua
