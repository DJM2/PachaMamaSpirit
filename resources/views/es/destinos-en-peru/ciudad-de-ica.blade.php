...
<head>
    ...
    <title>Ica, también conocida como la ciudad del eterno sol, cuna del pisco o ciudad del sol</title>
    <meta name="description"
        content="Ica es considerada la tierra del sol eterno, aquella donde será difícil que despiertes para ver días grises ya que el astro rey no se cansa de iluminar..." />
    <meta name="keywords"
        content="ciudad de Ica, Ica, ica ciudad, ciudad del eterno sol, Ica ciudad del eterno sol, la ciudad del pisco, ica pisco, pisco de ica, region inca, ica turismo, vacaciones en ica" />
    ...
    <link rel="canonical" href="https://pachamamaspirit.com/es/destinos-en-peru/ciudad-de-ica" />
</head>

<body>
    @include('layouts.menu-castellano')
    <li>
        <button onclick="window.location='{{ route('ica-city') }}'" class="castellano-es">English</button>
    </li>
