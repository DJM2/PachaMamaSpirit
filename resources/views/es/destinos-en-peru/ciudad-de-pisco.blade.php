...
<head>
    ...
    <title>Pisco, esta ciudad vio nacer a su homónima bebida. </title>
    <meta name="description"
        content="Pisco es una ciudad portuaria en la costa sur de Perú, conocida por su brandy de uva del mismo nombre. Es la entrada a las deshabitadas islas Ballestas." />
    <meta name="keywords"
        content="ciudad de pisco, ciudad de pisco, pisco sour, islas ballestas, candelabro de pisco, paseo en lancha, reserva natural pisco, lobos marinos, tour en lancha a pisco, turismo en pisco, tour islas ballestas" />
    ...
    <link rel="canonical" href="https://pachamamaspirit.com/es/destinos-en-peru/ciudad-de-pisco" />
</head>

<body>
    @include('layouts.menu-castellano')
    <li>
        <button onclick="window.location='{{ route('pisco-city') }}'" class="castellano-es">English</button>
    </li>
