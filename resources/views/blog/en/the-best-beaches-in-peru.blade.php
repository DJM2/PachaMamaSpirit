...
<head>
    ...
    <title>We have a list of the best beaches you can find on your visit to Peru</title>
    <meta name="description"
        content="If you are a lover of the coast, this blog is for you. Find out where the best beaches in Peru are and travel to them!" />
    <meta name="keywords"
        content="Punta Sal Beach, Puerto Inka, Bartolomeo Beach, Mancora, Caballeros Beach, Peruvian Sea, beaches of Peru, the best beaches of Peru" />
    <meta name="twitter:card" content="summary_large_image">
    <meta propererty="og:title" content="We have a list of the best beaches you can find on your visit to Peru">
    <meta property="og:image" content="https://pachamamaspirit.com/img/blog/the-best-beaches-of-Peru.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/blog/en/the-best-beaches-in-peru" />
</head>

<body>
    @include('layouts.menu')
    <li>
        <button onclick="window.location='{{ route('las-mejores-playas-peru') }}'"
