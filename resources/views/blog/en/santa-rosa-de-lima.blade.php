...
<head>
    ...
    <title>Santa Rosa de Lima, patron saint of the police and nurses of Peru</title>
    <meta name="description"
        content="Saint Rose of Lima, with the secular name Isabel Flores de Oliva, was a tertiary Dominican Catholic saint canonized by Pope Clement X in 1671." />
    <meta name="keywords"
        content="Santa Rosa de lima, santa rosa, peru santa rosa, miracles of santa rosa de lima, who was santa rosa de lima, who was santa rosa, saints of eru, peru holy men and women, peruvian" />
    <meta name="twitter:card" content="summary_large_image">
    <meta propererty="og:title" content="Santa Rosa de Lima, patron saint of the police and nurses of Peru">
    <meta property="og:image" content="https://pachamamaspirit.com/img/blog/santa-rosa-de-Lima-Pacha-Mama-Spirit.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/blog/en/santa-rosa-de-lima" />
</head>

<body>
    @include('layouts.menu')
    <li>
        <button onclick="window.location='{{ route('santa-rosa-de-lima-es') }}'" class="castellano-es">Español</button>
    </li>
