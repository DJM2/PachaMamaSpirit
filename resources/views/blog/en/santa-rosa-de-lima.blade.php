...
@php $descripcion="'Santa Rosa de Lima', patron saint of the national police of Peru, and representative of Peruvian nurses" @endphp
@php $keywords="Santa rosa de Lima, Saint peruvian, Peruvian Costums" @endphp
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <h2 class="text-center">"Saint Rosa de Lima: The patron saint of America"</h2>
