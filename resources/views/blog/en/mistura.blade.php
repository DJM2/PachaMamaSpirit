...
<head>
    ...
    <title>Mistura, the largest gastronomic fair in all of Latin America</title>
    <meta name="description"
        content="Mistura is the largest gastronomy fair in Latin America, with exquisite and varied dishes recognized worldwide." />
    <meta name="keywords"
        content="Mistura, Peruvian gastronomy, Peruvian gastronomy, typical dishes, typical Peruvian dishes, Peruvian ceviche, mistura fair, beer fair, beverage fair, typical drinks, Peru chefs, best gastronomy, recognized gastronomy" />
    <meta name="twitter:card" content="summary_large_image">
    <meta propererty="og:title" content="Mistura, the largest gastronomic fair in all of Latin America">
    <meta property="og:image" content="https://pachamamaspirit.com/img/blog/mistura-lima-peru-Pacha-mama-Spirit.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/blog/en/mistura" />
</head>

<body>
    @include('layouts.menu')
    <li>
        <button onclick="window.location='{{ route('mistura-es') }}'" class="castellano-es">Español</button>
    </li>
