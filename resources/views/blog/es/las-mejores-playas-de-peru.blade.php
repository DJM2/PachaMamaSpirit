...
<head>
    ...
    <title>Te tenemos una lista con las mejores playas que puedes encontrar en tu visita a Perú</title>
    <meta name="description"
        content="Si eres amante de la costa, este blog es para ti. Conoce donde se encuentran las mejores playas en Perú y viaja a ellas!" />
    <meta name="keywords"
        content="Playa punta sal, Puerto Inka, playa bartolomeo, mancora, Playa caballeros, Mar peruano, playas de peru, las mejores playas de peru" />
    <meta name="twitter:card" content="summary_large_image">
    <meta propererty="og:title"
        content="Te tenemos una lista con las mejores playas que puedes encontrar en tu visita a Perú">
    <meta property="og:image" content="https://pachamamaspirit.com/img/blog/the-best-beaches-of-Peru.webp" />
    <link rel="canonical" href="https://pachamamaspirit.com/blog/es/las-mejores-playas-de-peru" />
</head>

<body>
    @include('layouts.menu-castellano')
    <li>
        <button onclick="window.location='{{ route('the-best-beaches-peru') }}'" class="castellano-es">English</button>
    </li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <img src="{{ asset('img/blog/Playa-Punta-Sal-Pacha-Mama-Spirit.webp') }}"
                                        width="100%" alt="Punta sal beach" loading="lazy">
                                    <i>Playa Punta Sal</i>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <img src="{{ asset('img/blog/Playa-Mancora-Peru.webp') }}" width="100%"
                                        loading="lazy" alt="Playa Máncora - Perú">
