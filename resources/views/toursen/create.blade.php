...
@section('contenido')
    <div class="row text-white bg-dark mb-3" style="padding: 1em; border-radius: 10px;">
        <div class="col-lg-6 float-left">
            <h2>Crear Nuevo Tour en Ingles</h2>
        </div>
    ...
    <form method="POST" action="{{ route('toursen.store') }}" role="form" enctype="multipart/form-data" class="bg-light" style="padding: 1em">
        @csrf
        <div class="row">
            <div class="col-lg-6">
