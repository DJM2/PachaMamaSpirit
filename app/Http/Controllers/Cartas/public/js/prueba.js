...
function sumar(precio, num, producto) {
    ...
    var preciopop = sumaTotal / cantidad;
    /*  document.getElementById('popup1').innerHTML = preciopop; */
    var numpop = document.getElementById('valorpop');
    numpop.value = cantidad;
    sumarfinal = document.getElementById('final').innerHTML;

    valores.innerHTML += '<br> ➤ ' + +cantidad + '(' + izq + ')' + ' = s/.' + preciopop.toFixed(2) + ' → ' + sumaTotal;
...
/* function sumar(precio, num, producto) {
    ...
    var nuevoTotal = precioTotal + sumaTotal;
    document.getElementById('mtotal').innerHTML = 's/.' + nuevoTotal.toFixed(2);
     //Agregar valores s nuevo popup1
    var preciopop = nuevoTotal / cantidad;
    document.getElementById('popup1').innerHTML += 's/. ' + preciopop.toFixed(2);
