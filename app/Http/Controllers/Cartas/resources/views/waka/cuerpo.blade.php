...
<head>
    ...
    <link rel="icon" href="img/waka/favicon.png" tipe="image/png">
    <title>@yield('titulo')</title>
    <link rel="stylesheet" href="css/waka.css">
...
<body>
    ...
    <div class="fondo" id="pollos">
        <img src="img/waka/logo-waka-runtu.jpg" class="img-pikol" alt="">
    </div>
    @yield('contenido')
