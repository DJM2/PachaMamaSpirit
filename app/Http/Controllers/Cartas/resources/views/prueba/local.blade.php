...
<body>
    ...
    <script></script>
    <div class="menu">
        <ul data-v-1c8fdb5a="" data-v-3eb1d840="" class="category-slider px-0"
        ...
        <div class="row">
            <div class="col-4 d-flex">
                <div class="row" id="carrito">
                    ...
                    <div class="col-12" style="float: right" id="final">
                        <div class="row text-center">
                            <div class="col-4"><i class="fa-solid fa-minus"></i>
                            </div>
                            <div class="col-4">
                                <input type="text" id="valorpop" class="form-control input" readonly>
                            </div>
                            <div class="col-4">
            ...
            <div class="col-4" style="text-align: center; margin: auto; display: grid;">
                <a onclick="pedido2()" id="popup1-button"> Ver pedido</a>
            </div>
            <div class="col-4">
                <p id="mtotal"></p>
            </div>
    ...
    <div class="container mt-4">
        <div class="platos row">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pollo-entero-pikol.png" alt="Pikol pollo entero">
                    </div>
                    <div class="col-lg-6 col-sm-12" id="rowpollo">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/medio-pollo-a-la-brasa-pikol.png" alt="Pikol medio pollo">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/cuarto-pollo-a-la-brasa-pikol-polleria.png" alt="Pikol medio pollo">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-4pollo','num-4pollo','cuarto-pollo')">Agregar
                                            s/.<span id="valor-4pollo">25</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/lomo-saltado-pikol-cusco-djm2.jpg" alt="Pikol medio pollo">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/Tallarin-saltado-djm2-pikol.jpg" alt="Pikol medio pollo">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/chaufa-pikol-djm2.jpg" alt="Chaufa Pikol DJM2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-chaufa','num-chaufa','chaufa-pikol')">Agregar
                                            s/.<span id="valor-chaufa">30</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row margin-left">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-bistec','num-bistec','bistec-pobre')">Agregar
                                            s/.<span id="valor-bistec">30</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/Brochetas-de-pollo-pikol-DJM2.jpg" alt="Pikol medio pollo">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pollo-champinon-pikol-djm2.jpg" alt="Pollo en salsa de champiñones">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/caldo-de-gallina-pikol-djm2.jpg" alt="Caldo de gallina Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-chilcano-clasico" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-chilcano-maracuya" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-maracuya-caipiroska" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/mojito-pikol-djm2.jpg" alt="Mojito pikol djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-mojito-maracuya" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Chilcano clasico Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Choque y Fuga Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Chuspa Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Cojito Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Devocion Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-devocion" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
                                            onclick="incrementar('sub-devocion','num-devocion', 'valor-devocion')"></span>
                                    </div>
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-devocion','num-devocion','devocion')">Agregar
                                            s/.<span id="valor-devocion">25</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="Perlado Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/pikolpikolpikol.png" alt="La Brasita Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-piteadop" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
                                            onclick="incrementar('sub-piteadop','num-piteadop', 'valor-piteadop')"></span>
                                    </div>
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-piteadop','num-piteadop','piteadop')">Agregar
                                            s/.<span id="valor-piteadop">25</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly
                                            id="num-piteadoc" value="1">
                                        <span class="fa-solid fa-plus" id="botonactivo"
                                            onclick="incrementar('sub-piteadoc','num-piteadoc', 'valor-piteadoc')"></span>
                                    </div>
                                    <div class="col-6 d-flex dialog">
                                        <button class="enviarpedido"
                                            onclick="sumar('valor-piteadoc','num-piteadoc','piteadoc')">Agregar
                                            s/.<span id="valor-piteadoc">20</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="selectP zeniti" name="zeniti" id="zeniti"
                                            ...
                                            <option value="Trigonometria (IBU 19 - ALC5%)">Trigonometria (IBU 19 -
                                                ALC5%)</option>
                                            <option value="Pale Ale (IBU 34 - ALC2%)">Pale Ale (IBU 34 - ALC2%)
                                            </option>
                                            <option value="La hinchada peruana (IBU 19 - ALC5.5%)">La hinchada peruana
                                                (IBU 19 - ALC5.5%)</option>
                                            <option value="Porter con quinua (IBU 28 - ALC6.5%)">Porter con quinua
                                                (IBU
                                                28 - ALC6.5%)</option>
                                        </select>
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-lg-12 mb-4">
                <a class="fab fa-facebook redes" target="_blank"
                    href="https://www.facebook.com/PolleriasPikol"></a>
                <a class="fab fa-instagram redes" target="_blank"
                    href="https://www.instagram.com/pikolcusco/"></a>
            </div>
