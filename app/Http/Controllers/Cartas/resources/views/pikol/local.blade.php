                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-6 float-end" id="monto"></div>
                            </div>
                        </div>
                        <div class="col-12" id="valores2" style="text-align:initial">
    ...
    <div class="container mt-4">
        <div class="platos row">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/bisteck-montado-2.jpg" alt="Bisteck a lo pobre DJM2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
                                <span class="izq" id="bistec-pobre">Bisteck a lo Pobre</span>
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/alfredo-1.jpg" alt="Fetuchini Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/sopa-criolla-1.jpg" alt="Sopa a la minuta Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/dieta-pollo-1.jpg" alt="Dieta de pollo Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/mollejitas.jpg" alt="Mollejitas Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/salchibrasa-1.jpg" alt="SalchiBrasa Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/hamburguesa-2.jpg" alt="Hamburguesas Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/kero-1.jpg" alt="Kero Punch Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/chuspa-1.jpg" alt="Chuspa Djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/te-piteado-1.jpg" alt="Te Piteado Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/te-piteado-2.jpg" alt="Te piteado clásico Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/limonada.jpg" alt="Limonada djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/maracuya.jpg" alt="Maracuya djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/chicha.jpg" alt="Chicha morada djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/hierba-buena.jpg" alt="Hierba Buena djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/limonada-frozen.jpg" alt="Limonada Frozen djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/maracuya-frozen.jpg" alt="Maracuya Frozen djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/chicha-frozen.jpg" alt="Chicha morada Frozen djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/pikol/hierba-buena-frozen.jpg" alt="hierba buena Frozen djm2 Pikol">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
