    ...
    <div class="container mt-4">
        <div class="platos row">
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 d-flex dialog">
                                        ...
                                        <input type="text" class="form-control input" readonly id="num-asadoarroz"
                                            value="0">
                                        <span class="fa-solid fa-plus" id="botonactivo"
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/trujillano/lengua-con-arroz.jpg" alt="Lengua Guisada con Arroz y Frejoles djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/trujillano/lengua-con-pure.jpg" alt="Lengua Guisada con Arroz y Puré djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
            ...
            <div class="col-lg-6 plato">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <img src="img/trujillano/bisteck-con-papas.jpg" alt="Bisteck con Arroz y Papas Fritas djm2">
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="row margin-left">
                            <div class="col-12 pedido">
